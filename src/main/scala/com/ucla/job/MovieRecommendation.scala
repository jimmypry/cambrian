...
object MovieRecommendation {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    val lines = Source.fromFile("/Users/mac/IdeaProjects/cambrian/src/main/resources/input/ml-100k/u.item").getLines()
    for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val data = sc.textFile("/Users/mac/IdeaProjects/cambrian/src/main/resources/input/ml-100k/u.data")
